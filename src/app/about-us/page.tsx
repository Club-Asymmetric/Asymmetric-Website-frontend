...
export default function AboutUs() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white font-outfit overflow-x-hidden selection:bg-[#ccff00] selection:text-black">
      ...
      <section className="relative pt-8 pb-20 px-4 md:px-12 max-w-7xl mx-auto border-b border-zinc-800">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 border-b border-zinc-800 pb-4 mb-12 text-xs font-mono tracking-widest text-zinc-400">
          <div className="flex items-center gap-2">
            <span className="inline-block w-2 h-2 bg-[#ccff00] rounded-full animate-pulse"></span>
            <span>ABOUT ASYMMETRIC</span>
          </div>
          <div className="hidden sm:flex items-center gap-6">
            <span>[ EST. 2024 ]</span>
            <span>STUDENT COLLECTIVE</span>
            <span className="text-[#ccff00] font-bold">* NO LIMITS</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-block bg-[#ccff00] text-black font-mono font-bold text-xs px-3 py-1 uppercase tracking-wider -rotate-1">
              [ VOL. 01 — IDENTITY ]
            </div>

            <h1 className="text-6xl sm:text-7xl md:text-8xl xl:text-9xl font-black font-oswald uppercase leading-none tracking-tight">
              WE THINK<br />
              <span className="text-[#ccff00] underline decoration-4 underline-offset-8">DIFFERENTLY.</span>
            </h1>

            <p className="text-lg md:text-xl text-zinc-300 font-light max-w-xl leading-relaxed pt-4 border-l-2 border-[#ccff00] pl-4">
            ...
            <div className="pt-4 flex flex-wrap items-center gap-4 font-mono text-xs text-zinc-400">
              ...
              <span className="border border-zinc-700 px-3 py-1 bg-zinc-900/50 text-[#ccff00] border-[#ccff00]/40">04 / CHAOS</span>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 relative mt-6 lg:mt-0">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="absolute inset-0 bg-[#ccff00] translate-x-3 translate-y-3 rotate-2 opacity-80"></div>
              ...
              <div className="relative bg-zinc-900 border border-zinc-700 p-3 shadow-2xl -rotate-1 transition-transform hover:rotate-0 duration-300">
                <div className="overflow-hidden border border-zinc-800 relative group">
                  <img
                    ...
                    className="w-full h-[380px] sm:h-[440px] object-cover grayscale contrast-125 brightness-95 group-hover:scale-105 transition-transform duration-500"
                  />
                  ...
                  <div className="absolute bottom-3 right-3 text-[#ccff00] text-xl font-bold">
                    ★
                  </div>
                </div>
                ...
                <div className="pt-3 pb-1 flex justify-between items-center text-xs font-mono text-zinc-400">
                  ...
                  <span className="text-[#ccff00]">↗ [E-333R]</span>
                </div>
              </div>

              <div className="absolute -bottom-6 -left-6 bg-black border border-[#ccff00] text-[#ccff00] font-mono text-xs px-4 py-2 rotate-6 shadow-xl flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-6 space-y-4">
              ...
              <h2 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black font-oswald uppercase leading-none tracking-tight">
                ...
                <span className="text-black underline decoration-wavy decoration-[#ccff00] decoration-4">PERSPECTIVE.</span>
              </h2>
              ...
              <div className="pt-4 flex items-center gap-3 font-mono text-xs font-bold">
                <span className="bg-[#ccff00] border border-black text-black px-2 py-1">READ OUR LAWS ↘</span>
            ...
            <div className="lg:col-span-6">
              <div className="bg-[#0a0a0a] text-white p-8 md:p-12 border-2 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative rotate-1 hover:rotate-0 transition-transform duration-300">
                ...
                <div className="absolute -top-4 right-8 bg-[#ccff00] text-black font-mono text-[10px] font-bold px-3 py-1 border border-black uppercase tracking-widest">
                  {"CONFIDENTIAL // LAWS"}
                </div>

                <h3 className="font-mono text-xs text-[#ccff00] tracking-widest uppercase mb-6 border-b border-zinc-800 pb-3 flex justify-between">
                  <span>MANIFESTO</span>
                ...
                <ul className="space-y-4 font-oswald text-2xl sm:text-3xl md:text-4xl font-bold uppercase tracking-wide">
                  {manifestoItems.map((item, idx) => (
                    ...
                    >
                      <span className="group-hover:text-[#ccff00] transition-colors">{item}</span>
                      <span className="font-mono text-xs text-zinc-500 group-hover:text-[#ccff00]">0{idx + 1} ↗</span>
                    </motion.li>
                  ))}
                </ul>
                ...
                <div className="mt-8 pt-4 border-t border-zinc-800 text-xs font-mono text-zinc-400 flex items-center justify-between">
                  ...
                  <span className="text-[#ccff00] font-bold">NO EXCEPTIONS</span>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 px-4 md:px-12 max-w-7xl mx-auto relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          {storySteps.map((step, index) => (
            <div 
              key={index} 
              className={`bg-zinc-950 border border-zinc-800 p-6 md:p-8 relative ${step.rotation} hover:rotate-0 transition-transform duration-300 hover:border-[#ccff00]/50 group`}
            >
              <div className="flex items-center justify-between border-b border-zinc-800 pb-4 mb-6">
                <span className="text-4xl md:text-5xl font-black font-oswald text-[#ccff00]">
                  {step.num}
                </span>
              ...
              <div className="overflow-hidden border border-zinc-800 mb-6 relative">
                <img
                  src={step.image}
                  alt={step.title}
                  className="w-full h-52 object-cover grayscale contrast-125 group-hover:scale-105 transition-transform duration-500"
                />
                <div className="absolute top-2 right-2 bg-black/90 text-[#ccff00] font-mono text-[10px] px-2 py-0.5 border border-zinc-700">
                  IMG_LOG.{step.num}
                </div>
              </div>

              <h3 className="text-2xl md:text-3xl font-black font-oswald uppercase mb-1 text-white group-hover:text-[#ccff00] transition-colors">
                {step.title}
              </h3>
              ...
              <div className="mt-6 pt-4 border-t border-zinc-800/80 flex items-center justify-between font-mono text-[11px] text-zinc-500">
                ...
                <span className="text-[#ccff00] group-hover:translate-x-1 transition-transform">EXPAND ↗</span>
              </div>
            </div>
          ))}
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-12">
            ...
            <div className="lg:col-span-6 space-y-4">
              ...
              <h2 className="text-5xl sm:text-6xl md:text-7xl font-black font-oswald uppercase leading-none">
                ...
                IDEAS<br />
                EXPERIENCES<br />
                <span className="bg-black text-[#ccff00] px-3 py-1 inline-block rotate-1">EVERYTHING</span><br />
                IN BETWEEN.
              </h2>
            ...
            <div className="lg:col-span-6 relative">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="border-2 border-black bg-white p-2 shadow-md -rotate-2 hover:rotate-0 transition-transform">
                  <img 
                    src="/group-photo/JuniorMeet.jpg" 
                    alt="Community 1"
                    className="w-full h-44 object-cover grayscale contrast-125"
                  />
                ...
                <div className="border-2 border-black bg-white p-2 shadow-md rotate-3 hover:rotate-0 transition-transform mt-6">
                  <img 
                ...
                <div className="border-2 border-black bg-white p-2 shadow-md rotate-1 hover:rotate-0 transition-transform">
                  <img 
                ...
                <div className="border-2 border-black bg-white p-2 shadow-md -rotate-3 hover:rotate-0 transition-transform -mt-4">
                  <img 
      ...
      <section className="py-24 px-4 md:px-12 bg-[#0a0a0a] text-white text-center relative overflow-hidden">
        <div className="max-w-4xl mx-auto space-y-8 relative z-10">
          ...
          <div className="inline-block bg-zinc-900 border border-zinc-700 text-[#ccff00] font-mono text-xs px-4 py-1 uppercase tracking-widest">
            {"// JOIN THE COLLECTIVE"}
          </div>

          <h2 className="text-5xl sm:text-6xl md:text-7xl xl:text-8xl font-black font-oswald uppercase leading-none tracking-tight">
            YOU DO NOT HAVE<br />
            <span className="text-[#ccff00]">TO FIT THE PATTERN.</span>
          </h2>
          ...
          <div className="pt-6">
            <Link
              href="/contact-us"
              className="inline-flex items-center gap-3 bg-[#ccff00] text-black font-oswald text-xl sm:text-2xl font-bold uppercase px-10 py-5 hover:bg-white hover:scale-105 transition-all duration-300 border-2 border-black shadow-[6px_6px_0px_0px_rgba(255,255,255,0.2)]"
            >
