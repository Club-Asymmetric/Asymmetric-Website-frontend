...
const Events = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white font-outfit selection:bg-[#00008b] selection:text-white overflow-x-hidden">
      ...
      <section className="relative pt-8 pb-20 px-4 md:px-12 max-w-7xl mx-auto border-b border-zinc-800">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 border-b border-zinc-800 pb-4 mb-12 text-xs font-mono tracking-widest text-zinc-400">
          <div className="flex items-center gap-2">
            <span className="inline-block w-2.5 h-2.5 bg-[#00008b] rounded-full animate-ping"></span>
            <span className="text-[#00008b] font-bold">THINGS WE MAKE HAPPEN.</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-block bg-[#00008b] text-white font-mono font-bold text-xs px-3 py-1 uppercase tracking-widest -rotate-1">
            ...
            <p className="text-xl md:text-2xl text-zinc-300 font-light max-w-xl leading-relaxed border-l-2 border-[#00008b] pl-4">
            ...
            <div className="pt-4 flex items-center gap-4">
              <button
                ...
                className="bg-[#00008b] text-white font-oswald text-lg font-bold uppercase px-6 py-3 hover:bg-white hover:scale-105 transition-all border border-black shadow-[4px_4px_0px_0px_rgba(255,255,255,0.2)] flex items-center gap-2"
              >
          ...
          <div className="lg:col-span-5 relative mt-8 lg:mt-0">
            <div className="relative mx-auto max-w-md">
              ...
              <div className="absolute inset-0 bg-[#00008b] translate-x-4 translate-y-4 -rotate-3 opacity-90"></div>
              ...
              <div className="relative bg-zinc-900 border-2 border-zinc-700 p-3 shadow-2xl rotate-2 transition-transform hover:rotate-0 duration-300">
                <div className="overflow-hidden border border-zinc-800 relative group">
                  ...
                  <div className="absolute bottom-3 right-3 text-[#00008b] text-2xl font-bold">
                    *
                  </div>
                </div>
                ...
                <div className="pt-3 flex justify-between items-center text-xs font-mono text-zinc-400">
                  ...
                  <span className="text-[#00008b] font-bold">LIVE STAGE ↗</span>
                </div>
              </div>

              <div className="absolute -bottom-6 -left-6 bg-black border border-[#00008b] text-[#00008b] font-mono text-xs px-4 py-2 -rotate-6 shadow-xl">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between border-b-2 border-black pb-4 mb-12 font-mono text-xs font-bold tracking-widest text-black/70">
            <div className="flex items-center gap-2">
              ...
              <span className="text-base text-white bg-[#00008b] px-2 py-0.5 border border-black">[ FEATURED HEADLINE ]</span>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="flex items-center gap-4 font-mono text-xs font-bold text-black/70">
                <span className="bg-black text-[#00008b] px-3 py-1">OCT 12, 2025</span>
              ...
              <div className="pt-4 flex flex-wrap items-center gap-4">
                <button
                  ...
                  className="bg-[#00008b] text-white font-oswald text-xl font-bold uppercase px-8 py-4 hover:bg-black hover:text-white transition-all border-2 border-black shadow-[5px_5px_0px_0px_rgba(0,0,0,1)] flex items-center gap-2"
                >
                ...
                <button
                  ...
                  className="bg-black text-white font-mono text-sm px-6 py-4 hover:bg-[#00008b] hover:text-white transition-all border border-black"
                >
        ...
        {isOpen && (
          ...
          >
            ...
            >
              <button
                onClick={closePopup}
                className="absolute top-4 right-4 bg-black text-white hover:bg-[#00008b] hover:text-white p-2 transition-colors border border-black font-mono font-bold flex items-center gap-1"
              ...
              <div className="border-b-2 border-black pb-4 mb-6 pr-12">
                <div className="flex flex-wrap items-center gap-3 font-mono text-xs font-bold text-black/70 mb-2">
                  <span className="bg-black text-[#00008b] px-2 py-0.5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
                ...
                <div className="md:col-span-5">
                  <div className="group border-2 border-black p-2 bg-white shadow-md rotate-1">
                    <img
                ...
                <div className="md:col-span-7 space-y-6">
                  ...
                  <div className="pt-2 flex flex-wrap items-center gap-4">
                    <button
                      onClick={openRegistrationPage}
                      className="bg-black text-[#00008b] font-oswald text-lg font-bold uppercase px-8 py-3.5 hover:bg-[#00008b] hover:text-white transition-all border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] flex items-center gap-2"
                    >
