...
/*   5: {
  ...
  },
  {
    ...
    role: "Core Member",
    generation: 3,
    photos: ["DevendiranK1.jpg"],
    description:
      "Powered by vibe coding, questionable amounts of curiosity, PC games, and the dangerous confidence of \"bro, I can build that.\"\nCan go from fixing one tiny bug to redesigning the entire application, then casually disappear into a game for \"five minutes\" that somehow lasts three hours.\nAlso has a special talent for turning a simple idea into a full-blown project before anyone can say, \"Maybe keep it simple.\"",
    portfolio: "I don't have one",
    energySource: "8 hours of sleep, 2 hours of procrastination, food, and one dangerously productive burst at 2 AM.",
    dimension: "Somewhere between REM sleep, random thoughts, and \"5 more minutes bro.\"",
    type: "Sleep → Code → Game → Repeat",
    hobbiesInstalled: "Vibe-Coding, PC-Gaming, Bug-Creating, Bug-Fixing, Keyboard-Abuse, Random-Project-Spawning, and Professional-Procrastination",
    specialFeatures:
      "Can turn \"just one small change\" into a 3-hour side quest with 14 new ideas",
  },
  {
    id: "25",
