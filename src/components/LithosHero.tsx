...
export default function LithosHero() {
  ...
  return (
    <div
      className="lithos-hero min-h-screen bg-white tracking-[-0.02em]"
    ...
    >
      ...
      >
        ...
        >
          ...
          <button className="bg-[#e8702a] hover:bg-[#d2611f] text-white text-sm font-semibold py-3 px-6 rounded-full transition-all hover:scale-[1.03] active:scale-95 hover:shadow-lg hover:shadow-[#e8702a]/30">
            Start Digging
          </button>
        </div>
      </section>
