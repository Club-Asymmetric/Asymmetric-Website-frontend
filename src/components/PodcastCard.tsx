...
//             by
//           </p>
//           <p className="text-white text-lg md:text-xl font-light font-parisienne">
//             {author}
//           </p>
//         </div>
//         <p className="text-gray-300 text-xs md:text-sm px-2 md:px-4 leading-relaxed">
//           {description}
//         </p>
//         <button 
//           onClick={() => window.location.href = '/podcast'}
//           className="bg-cyan-500 text-white px-8 md:px-12 py-1 rounded-md hover:bg-white hover:text-black transition-all duration-300 mt-4"
//         >
//           Listen
//         </button>
//       </div>
...
const PodcastCard: React.FC<PodcastCardProps> = ({
  ...
  return (
    <div className="w-full max-w-[320px] bg-blue-950 rounded-2xl p-4 sm:p-6 my-8 md:my-10 relative">
      {/* Image */}
      <div className="absolute -top-10 left-1/2 -translate-x-1/2">
      ...
      <div className="pt-12 md:pt-16 pb-2 text-center space-y-3 md:space-y-5">
        ...
        <button
          onClick={() => window.location.href = '/podcast'}
          className="bg-cyan-500 text-white px-4 sm:px-8 md:px-12 py-1 rounded-md hover:bg-white hover:text-black transition-all duration-300 mt-4"
        >
          Listen
        </button>
      </div>
