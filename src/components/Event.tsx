                ...
                <div className="flex flex-col place-self-center w-full md:max-w-[58vw]">
                    ...
                    <div className="flex flex-col md:flex-row mt-[1rem]">
                        <div className="flex flex-row pr-0 md:pr-[5rem]">
                            <IoCalendarOutline className="ml-0 md:ml-[2rem] mr-[1rem] place-self-start w-[22px] h-[22px]" />
                        ...
                        <div className="flex flex-row mt-2 md:mt-0">
                            <RiMapPinLine className="ml-0 md:ml-[2rem] mr-[1rem] place-self-start h-[22px] w-[22px]" />
