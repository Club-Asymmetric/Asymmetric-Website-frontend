...
export default function Event(
    props: { 
        ...
        desc: string;
        location: string;
        openPopup: (content: { desc: string; img: string; name: string; }, e: React.MouseEvent) => void;
    }
) {
    ...
    return (
        <>
            <div className="flex flex-col md:flex-row pb-[3rem] px-[2rem] animate-zoomIn">
                <img src={props.imageSrc} className="place-self-center w-fit h-auto md:w-[250px] md:h-[250px] rounded-3xl"/>
